...
const GALLERY = [
  "/mma-1.jpg",
  "/trainers/WhatsApp Image 2025-05-14 at 17.26.43.jpeg",
  "/mma-3.jpg",
  "/images/WhatsApp Image 2025-05-14 at 17.26.47.jpeg",
];
    ...
    <div className="bg-[#07090F] text-white min-h-screen">
      <div className="relative h-[85vh] min-h-[600px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10">
          ...
          <motion.h1 className="bebas text-[clamp(5rem,16vw,13rem)] leading-none text-white mb-6"
          ...
          <motion.p className="text-white/60 max-w-lg text-base leading-relaxed mb-8"
            ...
            Dobrodošli u MMA tim Bosna Rudar. Posvećeni smo razvoju boraca u svim
            aspektima — džiu-džicu, rvanje, kickboxing i Muay Thai.
          </motion.p>
          <motion.button
      ...
      <Trainers />
      <ApplicationForm defaultSport="mma" locations={["Visoko","Kakanj","Breza"]}
        subtitle="MMA treninzi su dostupni u Visoku, Kaknju i Brezi. Plaćanje se vrši na račun trenera." />
      <section className="py-16 px-6 border-t border-white/[0.05] bg-[#07090F]">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row gap-8 text-sm text-white/40">
          <div className="flex items-center gap-3"><FaMapMarkerAlt className="text-[#D42020]" /><span>MMA sala — Visoko, Kakanj, Breza</span></div>
          <div className="flex items-center gap-3"><FaPhone className="text-[#D42020]" /><span>062 314 791 · 061 376 075</span></div>
        </div>
      </section>
    </div>
  );
